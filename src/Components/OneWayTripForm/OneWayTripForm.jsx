      ...
      <form className="create-trip-form" onSubmit={this.handleSubmit}>
        ...
        <div className="input-wrapper">
          <span
            ...
            className="input-wrapper__inputs input-wrapper__inputs--textarea-title"
          >
            {" "}
            Trip Reason
          </span>
          <input
            value={tripReason}
            className="input-wrapper__inputs input-wrapper__inputs--text-area"
            name="tripReason"
        ...
        <div className="input-wrapper">
          ...
          <input
            type="date"
            name="departureDate"
            className="input-wrapper__inputs input-wrapper__inputs--date"
            value={departureDate}
            min={today}
